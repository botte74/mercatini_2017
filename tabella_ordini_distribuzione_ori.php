<?php
	...
	$query = "SELECT or_numero, or_cliente, gr_barcode, gr_descrizioneunificata,
		...
		WHERE ri_stato = 4
		AND se_attiva = 'S' 
		GROUP BY or_numero, or_cliente, gr_barcode, gr_descrizioneunificata, ritardo, barcode ";
		...
		<div class="table-responsive">
			<div class="dt-example dt-example-bootstrap">
				<div class="container-fluid">
					<section>
						<table id="ordini" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th>Ordine</th>
									<th>Cliente</th>
							...
							?>
								<tr>
									...
									<td><div style="cursor:pointer;text-align:center" <?php echo "onClick=\"ristampa('" . $row['or_numero'] . "', '" .$row['gr_barcode'] . "');\""?>>

<?php
	...
	$sql_tempo="SELECT * FROM tempi WHERE tipo='griglie'";
...
<html>
	<head>
        ...
        <link href="css/style5.css" rel="stylesheet" media="screen">
		...
		<script src="js/griglie.js"></script>
	</head>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="tabella">
						<script>aggiornaTabellaGriglie()</script>
					</div>
				</div>
